...
namespace NSG.WebSrv.Domain.Entities.Migrations
{
    ...
    [Migration("20190906165748_Update-2019-09-06-13-00")]
    partial class Update201909061300
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.EmailTemplate", b =>
                {
                    b.Property<int>("CompanyId");
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.Incident", b =>
                {
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.IncidentIncidentNote", b =>
                {
                    b.Property<long>("IncidentId");
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.IncidentNote", b =>
                {
                    b.Property<long>("IncidentNoteId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.NIC", b =>
                {
                    b.Property<string>("NIC_Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16);
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.NoteType", b =>
                {
                    b.Property<int>("NoteTypeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("NoteTypeShortDesc")
                        .IsUnique()
                        .HasName("Idx_NoteType_ShortDesc");
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.Incident", b =>
                {
                    b.HasOne("NSG.WebSrv.Domain.Entities.NIC", "NIC")
                        .WithMany("Incidents")
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.IncidentIncidentNote", b =>
                {
                    b.HasOne("NSG.WebSrv.Domain.Entities.Incident", "Incident")
                        .WithMany("IncidentIncidentNotes")
                        .HasForeignKey("IncidentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NSG.WebSrv.Domain.Entities.IncidentNote", "IncidentNote")
                        .WithMany("IncidentIncidentNotes")
            ...
            modelBuilder.Entity("NSG.WebSrv.Domain.Entities.IncidentNote", b =>
                {
                    b.HasOne("NSG.WebSrv.Domain.Entities.NoteType", "NoteType")
